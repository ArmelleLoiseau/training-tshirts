...
var Track = function Track2(props) {
  ...
  var positonStyle = vertical ? (_ref = {}, _defineProperty(_ref, reverse ? "top" : "bottom", "".concat(offset2, "%")), _defineProperty(_ref, reverse ? "bottom" : "top", "auto"), _defineProperty(_ref, "height", "".concat(length, "%")), _ref) : (_ref2 = {}, _defineProperty(_ref2, reverse ? "right" : "left", "".concat(offset2, "%")), _defineProperty(_ref2, reverse ? "left" : "right", "auto"), _defineProperty(_ref2, "width", "".concat(length, "%")), _ref2);
  var elStyle = _objectSpread2(_objectSpread2({}, style2), positonStyle);
  return included ? import_react.default.createElement("div", {
    className,
    style: elStyle
  }) : null;
};
...
var Steps = function Steps2(_ref) {
  ...
  var elements = calcPoints(vertical, marks, dots, step, min, max).map(function(point) {
    ...
    var style2 = vertical ? _objectSpread2(_objectSpread2({}, dotStyle), {}, _defineProperty({}, reverse ? "top" : "bottom", offset2)) : _objectSpread2(_objectSpread2({}, dotStyle), {}, _defineProperty({}, reverse ? "right" : "left", offset2));
    if (isActived) {
      style2 = _objectSpread2(_objectSpread2({}, style2), activeDotStyle);
    }
    var pointClassName = (0, import_classnames.default)((_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-dot"), true), _defineProperty(_classNames, "".concat(prefixCls, "-dot-active"), isActived), _defineProperty(_classNames, "".concat(prefixCls, "-dot-reverse"), reverse), _classNames));
...
var Marks = function Marks2(_ref) {
  ...
  var elements = marksKeys.map(parseFloat).sort(function(a, b) {
    ...
    var markPointIsObject = _typeof(markPoint) === "object" && !import_react3.default.isValidElement(markPoint);
    var markLabel = markPointIsObject ? markPoint.label : markPoint;
    if (!markLabel && markLabel !== 0) {
      return null;
    }
    var isActive2 = !included && point === upperBound || included && point <= upperBound && point >= lowerBound;
    var markClassName = (0, import_classnames2.default)((_classNames = {}, _defineProperty(_classNames, "".concat(className, "-text"), true), _defineProperty(_classNames, "".concat(className, "-text-active"), isActive2), _classNames));
...
var Handle = function(_React$Component) {
  ...
  _createClass(Handle2, [{
    ...
    value: function render() {
      ...
      var className = (0, import_classnames3.default)(this.props.className, _defineProperty({}, "".concat(prefixCls, "-handle-click-focused"), this.state.clickFocused));
      var positionStyle = vertical ? (_ref = {}, _defineProperty(_ref, reverse ? "top" : "bottom", "".concat(offset2, "%")), _defineProperty(_ref, reverse ? "bottom" : "top", "auto"), _defineProperty(_ref, "transform", reverse ? null : "translateY(+50%)"), _ref) : (_ref2 = {}, _defineProperty(_ref2, reverse ? "right" : "left", "".concat(offset2, "%")), _defineProperty(_ref2, reverse ? "left" : "right", "auto"), _defineProperty(_ref2, "transform", "translateX(".concat(reverse ? "+" : "-", "50%)")), _ref2);
...
function isEventFromHandle(e, handles) {
  try {
    return Object.keys(handles).some(function(key) {
      return e.target === (0, import_react_dom2.findDOMNode)(handles[key]);
    });
  } catch (error) {
    return false;
  }
...
function createSlider(Component4) {
  var _a;
  return _a = function(_Component) {
    ...
    function ComponentEnhancer(props) {
      ...
      warning_default(step && Math.floor(step) === step ? isPointDiffEven : true, "Slider[max] - Slider[min] (".concat(max - min, ") should be a multiple of Slider[step] (").concat(step, ")"));
      _this.handlesRefs = {};
      return _this;
    }
    _createClass(ComponentEnhancer, [{
      ...
      value: function render() {
        ...
        var sliderClassName = (0, import_classnames4.default)(prefixCls, (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-with-marks"), Object.keys(marks).length), _defineProperty(_classNames, "".concat(prefixCls, "-disabled"), disabled), _defineProperty(_classNames, "".concat(prefixCls, "-vertical"), vertical), _defineProperty(_classNames, className, className), _classNames));
        return import_react5.default.createElement("div", {
        ...
        }), tracks, import_react5.default.createElement(Steps_default, {
          prefixCls,
          vertical,
          reverse,
          marks,
          ...
          dotStyle,
          activeDotStyle
        }), handles, import_react5.default.createElement(Marks_default, {
  ...
  }(Component4), _a.displayName = "ComponentEnhancer(".concat(Component4.displayName, ")"), _a.defaultProps = _objectSpread2(_objectSpread2({}, Component4.defaultProps), {}, {
    prefixCls: "rc-slider",
    className: "",
    min: 0,
    max: 100,
    ...
    handle: function handle(props) {
      ...
      return import_react5.default.createElement(Handle, _extends({}, restProps, {
        key: index2
      }));
    },
    onBeforeChange: noop,
...
var Slider = function(_React$Component) {
  ...
  _createClass(Slider2, [{
    ...
    value: function render() {
      ...
      var track = import_react6.default.createElement(Track_default, {
    ...
    value: function render() {
      ...
      var handles = bounds.map(function(v, i) {
        ...
        return handleGenerator({
          className: (0, import_classnames5.default)((_classNames = {}, _defineProperty(_classNames, handleClassName, true), _defineProperty(_classNames, "".concat(handleClassName, "-").concat(i + 1), true), _defineProperty(_classNames, "".concat(handleClassName, "-dragging"), dragging), _classNames)),
          prefixCls,
          vertical,
          dragging,
          offset: offsets[i],
      ...
      var tracks = bounds.slice(0, -1).map(function(_, index2) {
        var _classNames2;
        var i = index2 + 1;
        var trackClassName = (0, import_classnames5.default)((_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefixCls, "-track"), true), _defineProperty(_classNames2, "".concat(prefixCls, "-track-").concat(i), true), _classNames2));
        return import_react7.default.createElement(Track_default, {
...
function findDOMNode2(node) {
  ...
  return import_react_dom3.default.findDOMNode(node);
}
...
function useMountStatus(defaultValue) {
  ...
  var _useState = (0, import_react9.useState)(defaultValue), _useState2 = _slicedToArray(_useState, 2), val = _useState2[0], setVal = _useState2[1];
...
function useStatus(supportMotion, visible, getElement2, _ref) {
  ...
  var destroyedRef = (0, import_react12.useRef)(false);
  var cacheElementRef = (0, import_react12.useRef)(null);
...
function genCSSMotion(config) {
  ...
  var CSSMotion = React14.forwardRef(function(props, ref) {
    ...
    var renderedRef = React14.useRef(mergedVisible);
    if (mergedVisible) {
      renderedRef.current = true;
    }
    var setNodeRef = React14.useCallback(function(node) {
    ...
    if (!children) {
      ...
      motionChildren = children(_objectSpread2(_objectSpread2({}, mergedProps), {}, {
        className: (0, import_classnames6.default)(getTransitionName(motionName, status), (_classNames = {}, _defineProperty(_classNames, getTransitionName(motionName, "".concat(status, "-").concat(statusSuffix)), statusSuffix), _defineProperty(_classNames, motionName, typeof motionName === "string"), _classNames)),
        style: statusStyle
      }), setNodeRef);
    }
    return React14.createElement(DomWrapper_default, {
      ref: wrapperNodeRef
    }, motionChildren);
  });
  ...
  var CSSMotionList = function(_React$Component) {
    ...
    _createClass(CSSMotionList2, [{
      ...
      value: function render() {
        ...
        var _this$props = this.props, component = _this$props.component, children = _this$props.children, _onVisibleChanged = _this$props.onVisibleChanged, restProps = _objectWithoutProperties(_this$props, _excluded);
        var Component4 = component || React15.Fragment;
        var motionProps = {};
        ...
        return React15.createElement(Component4, restProps, keyEntities.map(function(_ref2) {
          var status = _ref2.status, eventProps = _objectWithoutProperties(_ref2, _excluded2);
          var visible = status === STATUS_ADD || status === STATUS_KEEP;
          return React15.createElement(CSSMotion, _extends({}, motionProps, {
            key: eventProps.key,
            visible,
            eventProps,
...
function Mask(props) {
  ...
  return React16.createElement(es_default, _extends({}, motion, {
    visible,
    removeOnLeave: true
  }), function(_ref) {
...
var Align = function Align2(_ref, ref) {
  ...
  if (import_react15.default.isValidElement(childNode)) {
    childNode = import_react15.default.cloneElement(childNode, {
      ref: composeRef(childNode.ref, nodeRef)
    });
  }
  return childNode;
};
var RcAlign = import_react15.default.forwardRef(Align);
RcAlign.displayName = "Align";
var Align_default = RcAlign;

// node_modules/rc-align/es/index.js
var es_default2 = Align_default;
...
var useVisibleStatus_default = function(visible, doMeasure) {
  var _useState = (0, import_react16.useState)(null), _useState2 = _slicedToArray(_useState, 2), status = _useState2[0], setInternalStatus = _useState2[1];
  var rafRef = (0, import_react16.useRef)();
  var destroyRef = (0, import_react16.useRef)(false);
  ...
  (0, import_react16.useEffect)(function() {
    ...
    if (status) {
      rafRef.current = wrapperRaf(_asyncToGenerator(import_regenerator.default.mark(function _callee() {
...
var useStretchStyle_default = function(stretch) {
  ...
  var style2 = React19.useMemo(function() {
    var sizeStyle = {};
    if (stretch) {
...
var PopupInner = React20.forwardRef(function(props, ref) {
  ...
  return React20.createElement(es_default, _extends({
    ...
    return React20.createElement(es_default2, {
...
// node_modules/rc-trigger/es/Popup/index.js
var _excluded3 = ["visible", "mobile"];
var Popup = React22.forwardRef(function(_ref, ref) {
  var visible = _ref.visible, mobile = _ref.mobile, props = _objectWithoutProperties(_ref, _excluded3);
...
function generateTrigger(PortalComponent) {
  var Trigger = function(_React$Component) {
    ...
    function Trigger2(props) {
      ...
      _this = _super.call(this, props);
      _this.popupRef = React24.createRef();
      _this.triggerRef = React24.createRef();
      ...
      _this.getRootDomNode = function() {
        ...
        try {
          var domNode = findDOMNode2(_this.triggerRef.current);
          if (domNode) {
            return domNode;
          }
        } catch (err) {
...
var es_default3 = generateTrigger(Portal_default);
...
var Tooltip = function Tooltip2(props, ref) {
  ...
  var getPopupElement = function getPopupElement2() {
    ...
    return [React26.createElement("div", {
      ...
      key: "arrow"
    }, arrowContent), React26.createElement(Content_default, {
      key: "content",
      prefixCls,
      id,
      overlay,
  ...
  return React26.createElement(es_default3, _extends({
...
var Tooltip_default = (0, import_react19.forwardRef)(Tooltip);

// node_modules/rc-tooltip/es/index.js
var es_default4 = Tooltip_default;

// node_modules/rc-slider/es/common/SliderTooltip.js
var SliderTooltip = React27.forwardRef(function(props, ref) {
  var visible = props.visible, overlay = props.overlay;
  var innerRef = React27.useRef(null);
  var tooltipRef = composeRef(ref, innerRef);
  var rafRef = React27.useRef(null);
...
// node_modules/rc-slider/es/createSliderWithTooltip.js
function createSliderWithTooltip(Component4) {
  var _a;
  return _a = function(_React$Component) {
    ...
    function ComponentWrapper() {
      ...
      _this.handleTooltipVisibleChange = function(index2, visible) {
        _this.setState(function(prevState) {
          return {
            visibles: _objectSpread2(_objectSpread2({}, prevState.visibles), {}, _defineProperty({}, index2, visible))
          };
        });
      };
      _this.handleWithTooltip = function(_ref) {
        ...
        return import_react20.default.createElement(SliderTooltip_default, _extends({}, restTooltipProps, {
          getTooltipContainer,
          prefixCls,
          overlay,
          placement,
          ...
          key: index2
        }), import_react20.default.createElement(Handle, _extends({}, restProps, {
    ...
    _createClass(ComponentWrapper, [{
      key: "render",
      value: function render() {
        return import_react20.default.createElement(Component4, _extends({}, this.props, {
          handle: this.handleWithTooltip
        }));
      }
    }]);
    return ComponentWrapper;
  }(import_react20.default.Component), _a.defaultProps = {
...
var es_default5 = InternalSlider;

// dep:rc-slider
var rc_slider_default = es_default5;
export {
  Handle,
  Range_default as Range,
  SliderTooltip_default as SliderTooltip,
  createSliderWithTooltip,
  rc_slider_default as default
};
/*!
